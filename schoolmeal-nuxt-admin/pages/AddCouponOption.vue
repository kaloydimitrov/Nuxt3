<template>
    <img
      ...
      >
    <ul v-else>
       //Todo Coupon Options list from storage
    </ul>
    //TODO add new coupon option
    ...
    <br/>
    <button @click="addFood()">Добави Купон</button>
    <br/>
...
export default {
  ...
  methods: {
    addFood(){
        ...
        {'foodName': this.foodName, 'price': this.price, 'size': this.size, 'size_metric': this.size_metric})
    },
